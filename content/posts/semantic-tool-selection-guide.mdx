...
<img
  src="/images/blogs/semantic-guide-vectorize-progress.png"
  alt="MCP Connect Inspector UI showing vectorization progress with tool count"
  style={{
    border: '2px solid #e5e7eb',
    borderRadius: '8px',
    margin: '2rem auto',
...
<img
  src="/images/blogs/semantic-guide-sync-complete.png"
  alt="MCP Connect Inspector UI showing successful sync status with tool count and hash"
  style={{
    border: '2px solid #e5e7eb',
    borderRadius: '8px',
    margin: '2rem auto',
...
<img
  src="/images/blogs/semantic-guide-neo4j-graph-model.png"
...
<img
  src="/images/blogs/semantic-guide-vector-search-results.png"
...
Notice how semantic search understands intent. "What's in the README?" doesn't contain the word "file" or "contents," but vector similarity correctly identifies `get_file_contents` as relevant.

<img
  src="/images/blogs/semantic-guide-readme-query-example.png"
  alt="MCP Connect Inspector UI showing semantic match for 'What's in the README' query finding get_file_contents tool"
  style={{
    border: '2px solid #e5e7eb',
    borderRadius: '8px',
    margin: '2rem auto',
