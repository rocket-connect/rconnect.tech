...
export function Join() {
  return (
    <div className="bg-rocket-connect-lightgrey w-full">
      <div className="py-20">
        <Container>
          <h2 className="font-bold text-center text-rocket-connect-darkblue text-4xl xl:text-5xl">
            Join our mission!
          </h2>
          <div className="flex align-center flex-col justify-center mt-10 text-center md:text-2xl italic text-rocket-connect-darkblue h-80">
